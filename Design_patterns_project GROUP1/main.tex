...
\begin{titlepage}
    ...
    label=\textbf{\arabic*.}, itemsep=0.2cm]
        ...
        \item \textbf{Tuheu Tchoubi Pempeme Moussa Fahdil [ICTU20241393]}
        \item \textbf{Kwete Ngnouba Rayan [ICTU20241377]}
        \item \textbf{Chijioke Emmanuel Izuchukwu [ICTU20241760]}
    \end{enumerate}
\end{minipage}
